...
<div class="card-body">
    <p class="login-box-msg">Vui lòng nhập địa chỉ email của bạn và chúng tôi sẽ gửi cho bạn hướng dẫn đặt lại mật khẩu.</p>

    <form id="forgetPasswordForm" method="post" action="{{ route('password.email') }}">
        {{ csrf_field() }}
        <div class="input-group form-group">
            <input class="form-control" type="text" name="official_email" value="{{ old('official_email') }}" placeholder="Địa chỉ email của bạn">
