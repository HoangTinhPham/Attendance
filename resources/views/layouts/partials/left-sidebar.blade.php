<aside class="main-sidebar sidebar-dark-primary elevation-4">
  ...
  <a href="/dashboard" class="brand-link">
    <div class="d-flex">
      ...
      @else
        <img src="{{ asset('assets/images/iuh.jpg') }}" alt="Logo" class="brand-image elevation-3 bg-white">
      @endif

      @if(isset($platform->name))
        <span class="brand-text font-weight-light">{{$platform->name}}</span>
      @else
        <span class="brand-text font-weight-light">WEB CHẤM CÔNG</span>
      @endif
