      ...
      <li class="nav-item">
        ...
        <div class="dropdown-menu dropdown-menu-right scale-up mr-2">
          <ul class="dropdown-user pl-3 pr-3">
            <div class="row">
              <div class="col-5 d-none d-lg-block d-md-block" style="width: 110px;">
              ...
              <div class="col-lg-7 col-md-7 col-sm-12">
                ...
                <div>
                  <a href="{{route('profile.index')}}" class="btn btn-rounded btn-danger btn-sm">{{Auth::user()->firstname}} {{ Auth::user()->lastname }}</a>
                </div>
              </div>
            </div>
            <hr class="mt-4 mb-2">
