...
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0">Vị trí</h1>
      </div>
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          <!-- <li class="breadcrumb-item"><a href="{{ url('branch') }}">Thiết lập</a></li> -->
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="text-right">
                            <button type="button" class="btn btn-info" data-toggle="modal" data-target="#create" title="Add Designation"><i class="fas fa-plus"></i><span class="d-none d-xs-none d-sm-inline d-md-inline d-lg-inline"> Thêm vị trí</span></button>
                        </div>
                                                ...
                                                <div class="modal-content">
                                                    <form action="{{ route('designation.delete' , $designation->id )}}" method="post">
                                                        ...
                                                        <div class="modal-header">
                                                            <h4 class="modal-title">Xóa vị trí</h4>
                                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                <span aria-hidden="true">×</span>
                                                            </button>
                                                        </div>
                                                        <div class="modal-body">
                                                            Bạn có muốn xóa vị trí "{{$designation->designation_name}}"?
                                                        </div>
                                                        <div class="modal-footer justify-content-between">
                                                            ...
                                                            <button  type="submit" class="btn btn-danger btn-ok" title="Delete Designation"><span class="d-xs-inline d-sm-none d-md-none d-lg-none"><i class="fas fa-trash-alt"></i></span><span class="d-none d-xs-none d-sm-inline d-md-inline d-lg-inline"> Xóa</span></button>
                                                        </div>
                                                    </form>
                                                </div>
                                            </div>
                                                    ...
                                                    <form id="editDesignationForm{{$designation->id}}" action="{{route('designation.update',['id'=>$designation->id])}}" method="post">
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="form-group">
                                                                <label class="control-label">Tên vị trí<span class="text-danger">*</span></label>
                                                                <input  type="text" name="name" value="{{old('name',$designation->designation_name)}}" placeholder="Nhập tên vị trí" class="form-control" id="designation_name{{$designation->id}}" oninput="check('designation_name'+{!! $designation->id !!});">
                                                                <span id="designation_name-error{{$designation->id}}" class="error invalid-feedback">Tên vị trí là bắt buộc</span>
                                                            </div>
                                                            <div class="form-group">
                                                        ...
                                                        <div class="modal-footer justify-content-between">
                                                            <button type="button" class="btn btn-default" data-dismiss="modal" title="Cancel"><span class="d-xs-inline d-sm-none d-md-none d-lg-none"><i class="fas fa-window-close"></i></span><span class="d-none d-xs-none d-sm-inline d-md-inline d-lg-inline"> Hủy bỏ</span></button>
                                                            <button type="button" onclick="validate({!! $designation->id !!});" class="btn btn-primary btn-ok" title="Update Designation"><span class="d-xs-inline d-sm-none d-md-none d-lg-none"><i class="fas fa-check-circle"></i></span><span class="d-none d-xs-none d-sm-inline d-md-inline d-lg-inline"> Cập nhật</span></button>
                                                        </div>
                                                    </form>
                                                </div>
                                            </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <form id="createDesignationForm" action="{{route('designation.create')}}" method="post">
                    {{ csrf_field() }}
                    <div class="modal-header">
                        <h4 class="modal-title">Tạo vị trí</h4>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">×</span>
                        </button>
                    </div>
                    <div class="modal-body">
                        <div class="form-group">
                            <label class="control-label">Tên vị trí<span class="text-danger">*</span></label>
                            <input  type="text" name="designation_name" placeholder="Nhập tên vị trí" class="form-control">
                        </div>
                        <div class="form-group">
                            <label class="control-label">Trạng thái</label>
                            <select name="status" class="form-control">
                    ...
                    <div class="modal-footer justify-content-between">
                        <button type="button" class="btn btn-default" data-dismiss="modal" title="Cancel"><span class="d-xs-inline d-sm-none d-md-none d-lg-none"><i class="fas fa-window-close"></i></span><span class="d-none d-xs-none d-sm-inline d-md-inline d-lg-inline"> Hủy bỏ</span></button>
                        <button  type="submit" class="btn btn-primary btn-ok" title="Create Designation"><span class="d-xs-inline d-sm-none d-md-none d-lg-none"><i class="fas fa-check-circle"></i></span><span class="d-none d-xs-none d-sm-inline d-md-inline d-lg-inline"> Tạo</span></button>
                    </div>
                </form>
            </div>
        </div>
