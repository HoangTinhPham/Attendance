...
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0">Loại nghỉ phép</h1>
      </div>
      <div class="col-sm-6">
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="text-right">
                            <button type="button" class="btn btn-info"  data-toggle="modal" data-target="#create" title="Add Leave Type"><i class="fas fa-plus"></i><span class="d-none d-xs-none d-sm-inline d-md-inline d-lg-inline"> Thêm loại nghỉ phép</span></button>
                        </div>
                                    ...
                                    @foreach($leave_types as $key =>$leave_type)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                @else
                                                    <div class="text-white badge badge-danger font-weight-bold">Ngưng hoạt động</div>
                                                @endif
                                            </td>
                                                ...
                                                <div class="modal-content">
                                                    <form id="updateLeaveTypeForm{{$leave_type->id}}" action="{{route('leave_type.update',['id'=>$leave_type->id])}}" method="post">
                                                        ...
                                                        <div class="modal-header">
                                                            <h4 class="modal-title">Cập nhật loại nghỉ phép</h4>
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="form-group">
                                                                ...
                                                                <span id="leave_type_name-error{{$leave_type->id}}" class="error invalid-feedback">Tên vị trí là bắt buộc</span>
                                                            </div>
                                                            <div class="form-group">
                                                                ...
                                                                <span id="leave_type_amount-error{{$leave_type->id}}" class="error invalid-feedback">Tên vị trí là bắt buộc</span>
                                                            </div>
                                                            <div class="form-group">
                                                                <label class="control-label">Trạng thái</label>
                                                                <select  name="status"  class="form-control">
                                                                    <option value="1" @if($leave_type->status==1)Selected @endif>Hoạt động</option>
                                                                    <option value="0" @if($leave_type->status==0)Selected @endif>Ngưng hoạt động</option>
                                                                </select>
                                                            </div>
                                                        </div>
                                                        <div class="modal-footer justify-content-between">
                                                            ...
                                                            <a onclick="validate({!! $leave_type->id !!});" class="btn btn-primary btn-ok" title="Update Leave Type"><span class="d-xs-inline d-sm-none d-md-none d-lg-none"><i class="fas fa-check-circle"></i></span><span class="d-none d-xs-none d-sm-inline d-md-inline d-lg-inline"> Cập nhật</span></a>
                                                        </div>
                                                    </form>
                                                </div>
                                            </div>
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <form action="{{ route('leave_type.delete' , $leave_type->id )}}" method="post">
                                                        {{ csrf_field() }}
                                                        <div class="modal-header">
                                                            <h4 class="modal-title">Xóa loại nghỉ phép</h4>
                                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                <span aria-hidden="true">×</span>
                                                            </button>
                                                        </div>
                                                        <div class="modal-body">
                                                            Bạn có muốn xóa loại nghỉ phép {{ $leave_type->name }}?
                                                        </div>
                                                        <div class="modal-footer justify-content-between">
                                                            <button type="button" class="btn btn-default" data-dismiss="modal" title="Cancel"><span class="d-xs-inline d-sm-none d-md-none d-lg-none"><i class="fas fa-window-close"></i></span><span class="d-none d-xs-none d-sm-inline d-md-inline d-lg-inline"> Hủy bỏ</span></button>
                                                            <button  type="submit" class="btn btn-danger btn-ok" title="Delete Leave Type"><span class="d-xs-inline d-sm-none d-md-none d-lg-none"><i class="fas fa-trash-alt"></i></span><span class="d-none d-xs-none d-sm-inline d-md-inline d-lg-inline"> Xóa</span></button>
                                                        </div>
                                                    </form>
                                                </div>
                                            </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <form id="leaveTypeForm" action="{{route('leave_type.create')}}" method="post">
                    {{ csrf_field() }}
                    <div class="modal-header">
                        <h4 class="modal-title">Tạo loại nghỉ phép</h4>
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                            <span aria-hidden="true">×</span>
                        </button>
                    </div>
                    ...
                    <div class="modal-footer justify-content-between">
                        <button type="button" class="btn btn-default" data-dismiss="modal" title="Cancel"><span class="d-xs-inline d-sm-none d-md-none d-lg-none"><i class="fas fa-window-close"></i></span><span class="d-none d-xs-none d-sm-inline d-md-inline d-lg-inline"> Hủy bỏ</span></button>
                        <button  type="submit" class="btn btn-primary btn-ok" title="Create Leave Type"><span class="d-xs-inline d-sm-none d-md-none d-lg-none"><i class="fas fa-check-circle"></i></span><span class="d-none d-xs-none d-sm-inline d-md-inline d-lg-inline"> Tạo</span></button>
                    </div>
                </form>
            </div>
        </div>
