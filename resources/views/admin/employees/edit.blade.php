                            ...
                            <div class="bs-stepper">
                                ...
                                <div class="bs-stepper-content pr-0 pl-0">
                                    <div id="personal-part" class="content" role="tabpanel" aria-labelledby="personal-part-trigger">
                                        <h5 class="pt-3"><strong>Thông tin cá nhân</strong></h5>
                                        <hr class="mt-0">
                                        <center>
                                            ...
                                            <br>
                                            <a class="btn btn-primary btn-sm mt-1" onclick="document.getElementById('wizard-picture').click();">Thêm ảnh</a>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text"  name="firstname" value="{{old('firstname', $employee->firstname)}}" class="form-control" placeholder="Nhập tên"/>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="control-label">Họ<span class="text-danger">*</span></label>
                                                    <input type="text" name="lastname" value="{{old('lastname',$employee->lastname)}}" class="form-control" placeholder="Nhập họ"/>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    <label class="control-label">Email chính thức<span class="text-danger">*</span></label>
                                    ...
                                    <div id="contact-part" class="content" role="tabpanel" aria-labelledby="contact-part-trigger" style="display: none;">
                                    ...
                                    <div id="additional-part" class="content" role="tabpanel" aria-labelledby="additional-part-trigger" style="display: none;">
                                    ...
                                    <div id="salary-part" class="content" role="tabpanel" aria-labelledby="salary-part-trigger" style="display: none;">
                                    ...
                                    <div id="role-part" class="content" role="tabpanel" aria-labelledby="role-part-trigger" style="display: none;">
                                    ...
                                    <div id="password-part" class="content" role="tabpanel" aria-labelledby="password-part-trigger" style="display: none;">
                                        <h5 class="pt-3"><strong>Thay đổi mật khẩu</strong></h5>
                                        <hr class="mt-0">
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                        ...
                                        <div>
                                            ...
                                            <button class="btn btn-primary float-right ml-1 update" data-toggle="tooltip" title="Update Employee"><span class="d-xs-inline d-sm-none d-md-none d-lg-none"><i class="fas fa-check-circle"></i></span><span class="d-none d-xs-none d-sm-inline d-md-inline d-lg-inline"> Cập nhật</span></button>
                                            <a class="btn btn-secondary float-right ml-1" onclick="stepper.previous()" data-toggle="tooltip" title="Previous Step"><span class="d-xs-inline d-sm-none d-md-none d-lg-none"><i class="fas fa-chevron-left"></i></span><span class="d-none d-xs-none d-sm-inline d-md-inline d-lg-inline"> Trở về</span></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            Bạn có muốn cập nhật nhân viên "{{ $employee->firstname }}"?
                                        ...
                                        <div class="modal-footer justify-content-between">
                                            <button type="button" class="btn btn-default" data-dismiss="modal"><span class="d-xs-inline d-sm-none d-md-none d-lg-none"><i class="fas fa-window-close"></i></span><span class="d-none d-xs-none d-sm-inline d-md-inline d-lg-inline"> Hủy bỏ</span></button>
                                            <button  type="submit" class="btn btn-primary btn-ok"><span class="d-xs-inline d-sm-none d-md-none d-lg-none"><i class="fas fa-check-circle"></i></span><span class="d-none d-xs-none d-sm-inline d-md-inline d-lg-inline"> Cập nhật</span></button>
                                        </div>
                                    </div>
                                </div>
                            </div>
