  ...
  <div class="container-fluid" style="display: none;">
    <div class="row">
      <div class="col-lg-4 col-md-4 col-sm-4">
        <div class="info-box" style="width: 610.2px;">
          ...
          @else
            ...
            <div class="info-box-content">
              <span class="info-box-text">Nghỉ phép đã duyệt</span>
        ...
        @if(Auth::user()->isAllowed('DashboardController:index'))
          <div class="card card-success" style="height: 100%;">
            <div class="card-header">
              <h3 class="card-title">Nhân viên được thêm gần đây</h3>
                ...
                <table class="table v-middle no-border">
                  ...
                  @foreach($employee as $employees)
                    <tr>
                      ...
                      <td align="right"><span class="label label-light-danger">{{$employees->joining_date}}</span></td>
                    </tr>
                  @endforeach
                  </tbody>
                </table>
      ...
      @if(Auth::user()->isAllowed('DashboardController:index'))
        <div class="col-lg-6">
          ...
          <div class="card card-success">
            <div class="card-header">
              <h3 class="card-title">Thống kê giới tính</h3>
