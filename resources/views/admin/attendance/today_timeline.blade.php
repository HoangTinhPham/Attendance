...
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0">Thời gian chấm công hôm nay</h1>
      </div>
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          <li class="breadcrumb-item"><a href="{{ url('attendance/today_timeline') }}">Chấm công</a></li>
          <li class="breadcrumb-item active">Dòng thời gian hôm nay</li>
        </ol>
      </div>
    </div>
  </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-md-3 col-sm-3">
                <div class="info-box">
                    ...
                    <div class="info-box-content">
                        <span class="info-box-text">Trễ</span>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                @foreach($employeeLeave as $key=>$leave)
                                                    @if( $employee->id==$key)
                                                        <p class="text-white badge badge-warning font-weight-bold">Nghỉ phép</p>
                                                    @endif
                                                @endforeach
                                                    ...
                                                    <div class="modal-content">
                                                        <form id="decisionForm{{ $employee['attendanceSummary'][0]->id }}" action="{{route('update.attendance.correction')}}" method='POST'>
                                                            ...
                                                            <div class="modal-header">
                                                                <h4 class="modal-title">Thay đổi chấm công</h4>
                                                            ...
                                                            <div class="modal-body">
                                                                Những thay đổi sau được yêu cầu đối với lần chấm công này:
                                                                <br><br>
                                                                    ...
                                                                    @foreach($attendance_corrections as $attendance_correction)
                                                                        @if($attendance_correction->date == $employee['attendanceSummary'][0]->date && $attendance_correction->employee_id == $employee['attendanceSummary'][0]->employee_id)
                                                                            ...
                                                                            @if($attendance_correction->time_in != '')
                                                                                <b>Thời gian bắt đầu:</b> {{$attendance_correction->time_in}}
                                                                                <br>
                                                                            @endif
                                                                            @if($attendance_correction->time_out != '')
                                                                                <b>Thời gian kết thúc:</b> {{$attendance_correction->time_out}}
                                                                                <br>
                                                                            @endif
                                                                            @if($attendance_correction->break_start != '')
                                                                                <b>Thời gian bắt đầu nghỉ:</b> {{$attendance_correction->break_start}}
                                                                                <br>
                                                                            @endif
                                                                            @if($attendance_correction->break_end != '')
                                                                                <b>Thời gian kết thúc nghỉ:</b> {{$attendance_correction->break_end}}
                                                                                <br>
                                                                            @endif
                                                                        @endif
                                                                    @endforeach
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-md-12">
                                                                        <div class="form-group">
                                                                            <label class="control-label">Quyết định<span class="text-danger">*</span></label>
                                                                            <select class="form-control custom-select" data-placeholder="Select Decision" tabindex="1" name="decision" id="decision{{ $employee['attendanceSummary'][0]->id }}" onchange="check('decision'+{!! $employee['attendanceSummary'][0]->id !!});">
                                                                                ...
                                                                                <option value="Rejected">Từ chố<i></i></option>
                                                                            </select>
                                                                            <span id="decision-error{{$employee['attendanceSummary'][0]->id}}"  class="error invalid-feedback">Quyết định là bắt buộc</span>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                            </div>
                                                            ...
                                                            <div class="modal-footer justify-content-between">
                                                                ...
                                                                <a class="btn btn-primary create-btn" onclick="validate({!! $employee['attendanceSummary'][0]->id !!});"><span class="d-xs-inline d-sm-none d-md-none d-lg-none"><i class="fas fa-check-circle"></i></span><span class="d-none d-xs-none d-sm-inline d-md-inline d-lg-inline"> Cập nhật</span></a>
                                                            </div>
                                                        </form>
                                                    </div>
                                                </div>
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <form action="{{route('attendance.storeAttendanceSummaryToday')}}" method='POST'>
                                                        ...
                                                        <div class="modal-header">
                                                            <h4 class="modal-title">Thêm/Cập nhật chấm công</h4>
                                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                <span aria-hidden="true">×</span>
                                                            </button>
                                                        </div>
                                                        ...
                                                        <div class="modal-body">
                                                            Điền vào biểu mẫu dưới đây để thêm / cập nhật lần chấm công của nhân viên "{{$employee['firstname']}} {{$employee['lastname']}}":
                                                            <div class="col-12 pt-2 pl-0 pr-0">
                                                                <div class="form-group">
                                                                    <label for="date">Ngày hôm nay</label>
                                                            ...
                                                            <div class="col-12 pl-0 pr-0">
                                                                <div class="form-group">
                                                                    <label for="date">Thời gian kết thúc</label>
                                                        ...
                                                        <div class="modal-footer justify-content-between">
                                                            <button type="button" class="btn btn-default" data-dismiss="modal"><span class="d-xs-inline d-sm-none d-md-none d-lg-none"><i class="fas fa-window-close"></i></span><span class="d-none d-xs-none d-sm-inline d-md-inline d-lg-inline"> Hủy bỏ</span></button>
                                                            <button type="submit" class="btn btn-primary create-btn"><span class="d-xs-inline d-sm-none d-md-none d-lg-none"><i class="fas fa-check-circle"></i></span><span class="d-none d-xs-none d-sm-inline d-md-inline d-lg-inline"> Có mặt</span></button>
                                                        </div>
                                                    </form>
                                                </div>
                                            </div>
