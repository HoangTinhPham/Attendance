...
@if(request()->is('attendance/create_break/*/*'))
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0">Thêm chấm công</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{ url('attendance/today_timeline') }}">Chấm công</a></li>
              <li class="breadcrumb-item"><a href="{{ url('attendance/today_timeline') }}">Mốc thời gian hôm nay</a></li>
              <li class="breadcrumb-item active">Thêm chấm công</li>
            </ol>
          </div>
        </div>
      </div>
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{ url('attendance/timeline') }}">Chấm công</a></li>
              <li class="breadcrumb-item"><a href="{{ url('attendance/timeline') }}">Mốc thời gian</a></li>
              <li class="breadcrumb-item active">Thêm chấm công</li>
            </ol>
          </div>
        </div>
    ...
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{ url('my/attendance') }}">Chấm công cá nhân</a></li>
              <li class="breadcrumb-item active">Thêm chấm công</li>
            </ol>
          </div>
        </div>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="row">
                            <div class="col-12">
                                @if(isset($attendance_summary) && Auth::user()->isAllowed('AttendanceController:Attendance_Summary_Delete'))
                                    <a data-toggle="modal" data-target="#confirm-delete{{$attendance_summary->id}}" class="btn btn-danger" title="Delete Attendance Summary"><span class=" d-xs-inline d-sm-none d-md-none d-lg-none"><i class="fas fa-trash-alt"></i></span><span class="d-none d-xs-none d-sm-inline d-md-inline d-lg-inline">Xóa</span></a>
                                @endif
                                @if(Auth::user()->isAllowed('LeaveController:adminCreate'))
                                    <button type="button" title="Add Employee Leave" onclick="window.location.href='{{route('admin.createLeave')}}'" class="btn btn-info float-right" ><i class="fas fa-plus"></i> <span class="d-none d-xs-none d-sm-inline d-md-inline d-lg-inline">Thêm nghỉ phép</span></button>
                                @endif
                            </div>
                        </div>
                        @if(Auth::user()->isAllowed('LeaveController:adminCreate') || Auth::user()->isAllowed('AttendanceController:Attendance_Summary_Delete'))
                            <hr>
                        @endif
                        <h5 class="pt-3"><strong>Chi tiết</strong></h5>
                        <hr class="mt-0">
                        <div class="row">
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="control-label">Trễ ? :</label>
                                    <div class="col-md-4 ">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="control-label">Tổng giờ:</label>
                                    <div class="col-md-3 ">
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    <label class="control-label">Tổng giờ đã kiểm tra:</label>
                                    <div class="col-md-4 ">
                                    ...
                                    <div class="modal-content">
                                        <form action="{{ route('attendance.delete' ,$attendance_summary->id)}}" method="post">
                                            ...
                                            <div class="modal-body">
                                                Bạn có muốn xóa chấm công của "@foreach($employees as $emp)
                                                @if($emp_id == $emp->id) {{$emp->firstname}} {{$emp->lastname}} @endif @endforeach"?
                                            </div>
                                            <div class="modal-footer justify-content-between">
                                                <button type="button" class="btn btn-default" title="Cancel" data-dismiss="modal"><span class="d-xs-inline d-sm-none d-md-none d-lg-none"><i class="fas fa-window-close"></i></span><span class="d-none d-xs-none d-sm-inline d-md-inline d-lg-inline"> Hủy bỏ</span></button>
                                                <button  type="submit" class="btn btn-danger btn-ok" title="Delete Attendance Summary"><span class="d-xs-inline d-sm-none d-md-none d-lg-none"><i class="fas fa-trash-alt"></i></span><span class="d-none d-xs-none d-sm-inline d-md-inline d-lg-inline"> Xóa</span></button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
                        ...
                        <form id="createBreakForm" @if(Auth::user()->isAllowed('AttendanceController:storeAttendanceSummaryToday')) action="{{route('attendance.storeAttendanceSummaryToday')}}" @else action="{{route('store.attendance')}}" @endif method='POST'>
                            {{csrf_field()}}
                            <h5 class="pt-3"><strong>Tạo giờ công</strong></h5>
                            <hr class="mt-0">
                            <div class="row">
                                @if(Auth::user()->isAllowed('AttendanceController:createBreak'))
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="control-label">Chọn tên<span class="text-danger">*</span></label>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <form class="addBreakForm" @if(Auth::user()->isAllowed('AttendanceController:storeAttendanceSummaryToday'))  action="{{route('attendance.storeBreak')}}" @else action="{{route('store.attendance.break')}}" @endif method='POST'>
                                        {{ csrf_field() }}
                                        <div class="modal-header">
                                            <h4 class="modal-title">Thêm giờ giải lao</h4>
                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                <span aria-hidden="true">×</span>
                                            </button>
                                        </div>
                                        <div class="modal-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        <label for="time_in">Giờ bắt đầu<span class="text-danger">*</span></label>
                                                        <input type="datetime-local" class="form-control" name="break_start">
                                                    </div>
                                                </div>
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        <label for="time_out">Giờ kết thúc<span class="text-danger">*</span></label>
                                                        <input type="datetime-local" class="form-control" name="break_end">
                                                    </div>
                                                </div>
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        <label for="time_out">Ghi chú</label>
                                        ...
                                        <div class="modal-footer justify-content-between">
                                            <button type="button" class="btn btn-default" title="Cancel" data-dismiss="modal"><span class="d-xs-inline d-sm-none d-md-none d-lg-none"><i class="fas fa-window-close"></i></span><span class="d-none d-xs-none d-sm-inline d-md-inline d-lg-inline"> Hủy</span></button>
                                            <button  type="submit" class="btn btn-primary btn-ok" title="Create Break"><span class="d-xs-inline d-sm-none d-md-none d-lg-none"><i class="fas fa-check-circle"></i></span><span class="d-none d-xs-none d-sm-inline d-md-inline d-lg-inline"> Tạo</span></button>
                                        </div>
                                    </form>
                                </div>
                            </div>
                                                    ...
                                                    <form class="addBreakForm" action="{{ route('attendance.updateBreak' , ['id'=>$att->id] )}}" method="post">
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="row">
                                                                ...
                                                                <div class="col-12">
                                                                    <div class="form-group">
                                                                        <label for="time">Giờ bắt đầu<span class="text-danger">*</span></label>
                                                                        <input type="datetime-local" class="form-control" name="break_start" value="{{date('Y-m-d\TH:i',strtotime($att->timestamp_break_start))}}" />
                                                                    </div>
                                                                </div>
                                                                <div class="col-12">
                                                                    <div class="form-group">
                                                                        <label for="time">Giờ kết thúc<span class="text-danger">*</span></label>
                                                        ...
                                                        <div class="modal-footer justify-content-between">
                                                            <button type="button" class="btn btn-default" title="Cancel" data-dismiss="modal"><span class="d-xs-inline d-sm-none d-md-none d-lg-none"><i class="fas fa-window-close"></i></span><span class="d-none d-xs-none d-sm-inline d-md-inline d-lg-inline"> Hủy</span></button>
                                                            <button  type="submit" class="btn btn-primary btn-ok" title="Update Break"><span class="d-xs-inline d-sm-none d-md-none d-lg-none"><i class="fas fa-check-circle"></i></span><span class="d-none d-xs-none d-sm-inline d-md-inline d-lg-inline"> Cập nhật</span></button>
                                                        </div>
                                                    </form>
                                                </div>
                                            </div>
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <form action="{{ route('attendance.deleteBreakChecktime' , ['id' => $att->id] )}}" method="post">
                                                        {{ csrf_field() }}
                                                        <div class="modal-header">
                                                            <h4 class="modal-title">Xóa giờ giải lao</h4>
                                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                <span aria-hidden="true">×</span>
                                                            </button>
                                                        </div>
                                                        <div class="modal-body">
                                                            Bạn có muốn xóa giờ giải lao từ <strong>{{Carbon\Carbon::parse($att->timestamp_break_start)->format('h:i a')}}</strong> đến <strong>{{Carbon\Carbon::parse($att->timestamp_break_end)->format('h:i a')}} </strong>vào <strong>{{Carbon\Carbon::parse($att->timestamp_break_end)->format('d-m-Y')}}</strong>?
                                                        </div>
                                                        <div class="modal-footer justify-content-between">
                                                            <button type="button" class="btn btn-default" title="Cancel" data-dismiss="modal"><span class="d-xs-inline d-sm-none d-md-none d-lg-none"><i class="fas fa-window-close"></i></span><span class="d-none d-xs-none d-sm-inline d-md-inline d-lg-inline"> Hủy</span></button>
                                                            <button  type="submit" class="btn btn-danger btn-ok" title="Delete Break"><span class="d-xs-inline d-sm-none d-md-none d-lg-none"><i class="fas fa-trash-alt"></i></span><span class="d-none d-xs-none d-sm-inline d-md-inline d-lg-inline"> Xóa</span></button>
                                                        </div>
                                                    </form>
                                                </div>
                                            </div>
