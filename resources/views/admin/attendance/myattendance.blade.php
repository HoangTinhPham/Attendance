...
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0">Chấm công cá nhân</h1>
      </div>
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          <li class="breadcrumb-item"><a href="{{ url('my/attendance') }}">Chấm công</a></li>
          <li class="breadcrumb-item active">Chấm công cá nhân</li>
        </ol>
      </div>
    </div>
  </div>
        ...
        <div class="row">
            ...
            <div class="col-md-3">
                <div class="info-box">
                    ...
                    <div class="info-box-content">
                        <span>Giờ vào làm trung bình</span>
            ...
            <div class="col-md-3">
                <div class="info-box">
                    ...
                    <div class="info-box-content">
                        <span class="info-box-text"><b>{{$present}}</b> Có mặt</span>
                        <span class="info-box-text"><b>{{$leaveCount}}</b> Nghỉ phép</span>
                        <span class="info-box-text"><b>{{$absent}}</b> Vắng mặt</span>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="row justify-content-between pl-2 pr-2">
                            ...
                            <div>
                                @if(Auth::user()->isAllowed('AttendanceController:storeAttendanceSummaryToday') || $summaryDate == '')
                                    <a type="button" href="{{route('add.attendance', Auth::user()->id)}}/{{$today}}" class="btn btn-info btn-rounded ml-1" title="Add Attendance"><i class="fas fa-plus"></i> <span class="d-none d-xs-none d-sm-inline d-md-inline d-lg-inline">Thêm chấm công</span></a>
                                @endif
                            </div>
                        </div>
                                ...
                                <div class="modal-content">
                                    ...
                                    {{csrf_field()}}
                                        <div class="modal-header">
                                            <h4 class="modal-title">Giải trình giờ công</h4>
                                            ...
                                            <div class="row">
                                                <div class="form-group col-md-12">
                                                    ...
                                                    @if(!isset($platform->hr_email) && !isset($platform->hr_email))
                                                        <span class="text-danger">Vui lòng cài đặt platform để nhận email trên email công ty của bạn.</span>
                                                    @endif
                                                </div>
                                                <div class="form-group col-md-12">
                                                    <label class="control-label">CC tới quản lý</label>
                                                ...
                                                <div class="form-group col-md-12">
                                                    <label class="control-label">Thông báo<span class="text-danger">*</span></label>
                                        ...
                                        <div class="modal-footer justify-content-between">
                                            ...
                                            <button  type="submit" class="btn btn-primary btn-ok" title="Delete Attendance Summary"><span class="d-xs-inline d-sm-none d-md-none d-lg-none"><i class="fas fa-check-circle"></i></span><span class="d-none d-xs-none d-sm-inline d-md-inline d-lg-inline"> Gửi</span></button>
                                        </div>
                                    </form>
                                </div>
                            </div>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    ...
                                    {{csrf_field()}}
                                        ...
                                        <div class="modal-header">
                                            <h4 class="modal-title">Chỉnh sửa thời gian</h4>
                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                <span aria-hidden="true">×</span>
                                            </button>
                                        </div>
                                        <div class="modal-body">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        <label for="time_in">Giờ bắt đầu nghỉ</label>
                                                        <input type="time" class="form-control" name="break_start" value="">
                                                    </div>
                                                </div>
                                                <div class="col-12">
                                                    <div class="form-group">
                                                        <label for="time_out">Giờ kết thúc nghỉ</label>
