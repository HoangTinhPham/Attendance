...
@section('Heading')
    ...
    <ol class="breadcrumb">
        <li class="breadcrumb-item"><a href="javascript:void(0)">Chấm công</a></li>
        <li class="breadcrumb-item active">Mốc thời gian</li>
    </ol>
@stop
@section('content')
<!-- Breadcrumbs Start -->
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="text-right">
                            <button type="button" onclick="window.location.href='{{route('attendance.createBreak')}}'" class="btn btn-info btn-rounded" title="Add Attendance"><i class="fas fa-plus"></i> <span class="d-none d-xs-none d-sm-inline d-md-inline d-lg-inline">Thêm chấm công</span></button>
                        </div>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="selectOffice">
                                        <option value="0" @if($branch_id == 0) selected @endif>Các văn phòng</option>
