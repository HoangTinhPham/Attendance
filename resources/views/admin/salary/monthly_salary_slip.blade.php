...
<div class="content-header">
	<div class="container-fluid">
		<div class="row mb-2">
			<div class="col-sm-6">
				<h1 class="m-0">Hiển thị phiếu lương</h1>
			</div>
			<div class="col-sm-6">
				<ol class="breadcrumb float-sm-right">
					<li class="breadcrumb-item"><a href="{{ url('salary') }}">Phiếu lương</a></li>
							...
							<table style="width: 100%;">
								...
								<tr>
									...
									<td style="position: relative;">
										<div class="col-sm-12 pl-0" style="position: absolute; top: 0; display: none;"> 
											<div>
								...
								<tr>
									<td class="col-sm-6 pl-0">
										<div class=" bg-dark">
											<h6 class="d-flex justify-content-between pl-1 pr-3 pt-1 pb-1"><div>Lương hiện tại:</div>${{$subtotal}}</h6>
										</div>
									</td>
									<td class="col-sm-6 pl-0" style="display:none;">
										<div class="bg-dark">
