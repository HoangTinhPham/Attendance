...
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0">Phiếu lương</h1>
      </div>
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          <li class="breadcrumb-item"><a href="{{ url('salary/slips') }}">Thanh toán</a></li>
                            ...
                            <table id="salary" class="table table-bordered table-striped table-hover">
								<thead>
									<tr>
										...
										<th>Tổng lương</th>
										<th>Thưởng</th>
										<th>Ngày nghỉ phép đã phê duyệt</th>
										<th>Ngày nghỉ phép chưa phê duyệt</th>
										<th>Vắng mặt</th>
										<th>Có mặt</th>
