    ...
    <div class="row mb-2">
      ...
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          <li class="breadcrumb-item"><a href="{{ url('salary') }}">Thanh toán</a></li>
                ...
                <div class="card">
                    <div class="card-body">
                    	<div class="d-flex justify-content-between col-12 pl-0">
	                    	<h4 class="card-title pt-2 font-weight-bold">Lương nhân viên</h4>
                            ...
                            <table id="salary" class="table table-bordered table-striped table-hover">
								<thead>
									<tr>
										...
										<th>Tổng lương</th>
										<th>Thưởng</th>
										<th>Ngày nghỉ phép đã duyệt</th>
										<th>Ngày nghỉ phép chưa duyệt</th>
										<th>Vắng mặt</th>
										<th>Có mặt</th>
										<!-- <th>Thuế</th> -->
										<th>Thêm tiền thưởng</th>
									</tr>
								</thead>
								<tbody>
												...
												<div class="modal-content">
													<form action="{{route('salary.bonus',['id'=>$employee->id])}}" method="post">
														...
														<div class="modal-header">
                                                            <h4 class="modal-title">Thêm tiền thưởng nhân viên "{{$employee->firstname}}"</h4>
														...
														<div class="modal-body">
															<div class="form-group">
																<label class="control-label">Số tiền thưởng</label>
														...
														<div class="modal-footer justify-content-between">
                                                            ...
                                                            <button  type="submit" class="btn btn-primary btn-ok" title="Add Bonus"><span class="d-xs-inline d-sm-none d-md-none d-lg-none"><i class="fas fa-check-circle"></i></span><span class="d-none d-xs-none d-sm-inline d-md-inline d-lg-inline"> Thêm</span></button>
														</div>
													</form>
												</div>
											</div>
