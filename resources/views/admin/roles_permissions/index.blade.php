...
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0">Vai trò và phân quyền</h1>
      </div>
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          <li class="breadcrumb-item"><a href="{{ url('roles') }}">Quản lý vai trò</a></li>
          <li class="breadcrumb-item active">Vai trò và phân quyền</li>
        </ol>
      </div>
    </div>
  </div>
                ...
                <div class="card">
                    <div class="card-body">
						<div class="text-right">
							<button type="button" onclick="window.location.href='{{route('roles_permissions.create')}}'" class="btn btn-info btn-rounded"><i class="fas fa-plus"></i><span class="d-none d-xs-none d-sm-inline d-md-inline d-lg-inline"> Thêm vai trò</span></button>
                        </div>
												...
												<div class="modal-content">
													<form action="{{ route('roles_permissions.delete' , $role->id )}}" method="post">
														...
														<div class="modal-body">
															Bạn có muốn xóa vai trò "{{$role->name}}"?
														</div>
														<div class="modal-footer justify-content-between">
															<button type="button" class="btn btn-default" data-dismiss="modal">Hủy bỏ</button>
															<button  type="submit" class="btn btn-danger btn-ok">Xóa</button>
														</div>
													</form>
												</div>
											</div>
