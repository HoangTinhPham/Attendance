...
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0">Nhân viên nghỉ phép</h1>
      </div>
      <div class="col-sm-6">
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between">
                            <select class="form-control col-2" id="filter">
                                <option>All</option>
                                <option @if($id=='Approved') selected @endif>Đã Duyệt</option>
                                <option @if($id=='Declined') selected @endif >Chưa Duyệt</option>
                            </select>
                            @if(Auth::user()->isAllowed('LeaveController:adminCreate'))
                                <button type="button"  onclick="window.location.href='{{route('admin.createLeave')}}'" class="btn btn-info btn-rounded" title="Add Employee Leave"><i class="fas fa-plus"></i><span class="d-none d-xs-none d-sm-inline d-md-inline d-lg-inline"> Thêm nhân viên nghỉ phép</span></button>
                            @endif
                        </div>
                                                ...
                                                @if(Auth::user()->id == 1 || (Auth::user()->id != $employee->id))
                                                    <form id="statusForm" action="/leave/updateStatus" method="post">
                                                        ...
                                                        <select class="form-control" name="status" style="width:160px;" onchange="$('#statusForm').submit();">
                                                            ...
                                                            <option value="Declined">Chưa duyệt</option>
                                                        </select>
                                                    </form>
                                                @endif
                                            @endif
                                            ...
                                            <div class="modal-content">
                                                <form action="{{ route('leave.delete' , $employee->leave_id)}}" method="post">
                                                    ...
                                                    <div class="modal-footer justify-content-between">
                                                        ...
                                                        <button  type="submit" class="btn btn-danger btn-ok" title="Delete Leave"><span class="d-xs-inline d-sm-none d-md-none d-lg-none"><i class="fas fa-trash-alt"></i></span><span class="d-none d-xs-none d-sm-inline d-md-inline d-lg-inline"> Xóa</span></button>
                                                    </div>
                                                </form>
                                            </div>
                                        </div>
