...
<div class="content-header">
  <div class="container-fluid">
    <div class="row mb-2">
      <div class="col-sm-6">
        <h1 class="m-0">Nhóm</h1>
      </div>
      <div class="col-sm-6">
        <ol class="breadcrumb float-sm-right">
          <li class="breadcrumb-item"><a href="{{ url('teams') }}">Quản lý nhân viên</a></li>
                ...
                <div class="card">
                    <div class="card-body">
                        <div class="text-right">
                            <button type="button" class="btn btn-info btn-rounded" data-toggle="modal" data-target="#create" title="Add Team"><i class="fas fa-plus"></i><span class="d-none d-xs-none d-sm-inline d-md-inline d-lg-inline">Thêm nhóm</span></button>
                        </div>
                                    ...
                                    @foreach($teams as $key => $team)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                @if($team->status==1)
                                                    <div class="text-white badge badge-success font-weight-bold">Hoạt động</div>
                                                @else
                                                ...
                                                <div class="modal-content">
                                                    <form action="{{ route('team.delete' , $team->id )}}" method="post">
                                                        ...
                                                        <div class="modal-body">
                                                            Bạn có muốn xóa nhóm không "{{ $team->name}}"?
                                                        </div>
                                                        <div class="modal-footer justify-content-between">
                                                            ...
                                                            <button  type="submit" class="btn btn-danger btn-ok" title="Delete Team"><span class="d-xs-inline d-sm-none d-md-none d-lg-none"><i class="fas fa-trash-alt"></i></span><span class="d-none d-xs-none d-sm-inline d-md-inline d-lg-inline"> Xóa</span></button>
                                                        </div>
                                                    </form>
                                                </div>
                                            </div>
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <form id="updateTeamForm{{$team->id}}" action="{{route('team.update',['id'=>$team->id])}}" method="post">
                                                        {{ csrf_field() }}
                                                        <div class="modal-header">
                                                            <h4 class="modal-title">Cập nhật nhóm</h4>
                                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                <span aria-hidden="true">×</span>
                                                            </button>
                                                        </div>
                                                        <div class="modal-body">
                                                            <div class="col-12 pl-0 pr-0">
                                                                <div class="form-group">
                                                                    ...
                                                                    <span id="team_name-error{{$team->id}}" class="error invalid-feedback">Tên nhóm là bắt buộc</span>
                                                                </div>
                                                            </div>
                                                            <div class="col-12 pl-0 pr-0">
                                                                <div class="form-group">
                                                            ...
                                                            <div class="col-12 pl-0 pr-0">
                                                                <div class="form-group">
                                                                    ...
                                                                    <select  name="status"  class="form-control">
                                                                        <option value="1" @if($team->status == 1) selected @endif>Hoạt động</option>
                                                                        <option value="0" @if($team->status == 0) selected @endif>Ngừng hoạt động</option>
                                                                    </select>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="modal-footer justify-content-between">
                                                            <button type="button" class="btn btn-default" data-dismiss="modal" title="Cancel"><span class="d-xs-inline d-sm-none d-md-none d-lg-none"><i class="fas fa-window-close"></i></span><span class="d-none d-xs-none d-sm-inline d-md-inline d-lg-inline"> Hủy bỏ</span></button>
                                                            <a onclick="validate({!! $team->id !!});" class="btn btn-primary btn-ok" title="Update Team"><span class="d-xs-inline d-sm-none d-md-none d-lg-none"><i class="fas fa-check-circle"></i></span><span class="d-none d-xs-none d-sm-inline d-md-inline d-lg-inline"> Cập nhật</span></a>
                                                        </div>
                                                    </form>
                                                </div>
                                            </div>
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <form action="{{route('team_member.add')}}" method="post">
                                                        {{ csrf_field() }}
                                                        <div class="modal-header">
                                                            <h4 class="modal-title">Thêm nhân viên vào nhóm {{$team->name}}</h4>
                                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                                <span aria-hidden="true">×</span>
                                                            </button>
                                                        </div>
                                                        ...
                                                        <div class="modal-footer justify-content-between">
                                                            <button type="button" class="btn btn-default" data-dismiss="modal" title="Cancel"><span class="d-xs-inline d-sm-none d-md-none d-lg-none"><i class="fas fa-window-close"></i></span><span class="d-none d-xs-none d-sm-inline d-md-inline d-lg-inline"> Hủy bỏ</span></button>
                                                            <button  type="submit" class="btn btn-primary btn-ok" title="Add Employee To Team"><span class="d-xs-inline d-sm-none d-md-none d-lg-none"><i class="fas fa-check-circle"></i></span><span class="d-none d-xs-none d-sm-inline d-md-inline d-lg-inline"> Thêm nhân viên vào nhóm</span></button>
                                                        </div>
                                                    </form>
                                                </div>
                                            </div>
                            ...
                            <div class="modal-dialog">
                                <div class="modal-content">
                                    <form id="createTeamForm" action="{{route('team.create')}}" method="post">
                                        ...
                                        <div class="modal-footer justify-content-between">
                                            <button type="button" class="btn btn-default" data-dismiss="modal" title="Cancel"><span class="d-xs-inline d-sm-none d-md-none d-lg-none"><i class="fas fa-window-close"></i></span><span class="d-none d-xs-none d-sm-inline d-md-inline d-lg-inline"> Hủy bỏ</span></button>
                                            <button  type="submit" class="btn btn-primary btn-ok" title="Create Team"><span class="d-xs-inline d-sm-none d-md-none d-lg-none"><i class="fas fa-check-circle"></i></span><span class="d-none d-xs-none d-sm-inline d-md-inline d-lg-inline"> Tạo</span></button>
                                        </div>
                                    </form>
                                </div>
                            </div>
