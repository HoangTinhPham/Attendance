...
<head>
    ...
    @else
        <link rel="icon" type="image/png" sizes="16x16" href="{{asset('assets/images/iuh.jpg')}}">
    @endif
...
<body>
    <div class="flex-center position-ref full-height">
        ...
        <div class="top-right links">
            ...
            {{-- <a class="reg" href="{{ route('register') }}">Đăng ký</a> --}}
            @endauth
        </div>
        @endif
        ...
        <div class="content">
            <div>
                <h1>Welcome to HRM by @if($platform != '') {{$platform->name}} @else WEB CHẤM CÔNG @endif</h1>
            </div>
